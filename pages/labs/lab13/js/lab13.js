//Linted Lab 7
//Note, JSLint doesn't recognize document by default
//So it has to be added to "global variables"
//There's 2 strings (lines 55 and 66) that go over the 80 character limit
//I don't feel like shortening these makes much sense so I left them there
//Everything else should pass perfectly
...
function validate()
{
    ...
    if (ageFormIsValid &&
           (parseInt(ageFormValue) < 0 || parseInt(ageFormValue) > 120))
    {
    ...
    //If the insurance form contains an integer
        //but is outside of the accepted range
    if (insuranceFormIsValid &&
           (parseInt(insuranceFormValue) < 2
            || parseInt(insuranceFormValue) > 6))
    {
